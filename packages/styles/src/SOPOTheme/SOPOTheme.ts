...
export const SOPOLightTheme:SOPOTheme =Object.freeze({
    ...
    mainBackground:SOPOColor.LightGreen95,
    signButton:SOPOColor.Green60,
    buttonColor:SOPOColor.Green50,
    statusRed:SOPOColor.Red50,
    statusYellow:SOPOColor.Yellow50,
    statusGreen:SOPOColor.Green50,
    disable:SOPOColor.Neutral90,
    lightDisable:SOPOColor.Neutral95,
